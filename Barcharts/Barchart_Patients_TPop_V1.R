...
write.table(LabelCountsTable, file = "./3_Output/Barcharts/Patients/OnlyT_Populations/LabelCountsTable_Patients_TPop.txt", sep = "\t", row.names = FALSE)
...
write.table(PercentagesLabel, file = "./3_Output/Barcharts/Patients/OnlyT_Populations/PercentagesLabel_Patients_TPop.txt", sep = "\t", row.names = T, col.names = NA)
...
ggsave(filename = "./3_Output/Barcharts/Patients/OnlyT_Populations/Dendrogram_Patients_TPop.pdf", p.den)
ggsave(filename = "./3_Output/Barcharts/Patients/OnlyT_Populations/OrderedBargraph_Patients_TPop.pdf", p.bar)
...
ggsave(filename = "./3_Output/Barcharts/Patients/OnlyT_Populations/DendrogramCol_Patients_TPop.pdf", p.den.col)
