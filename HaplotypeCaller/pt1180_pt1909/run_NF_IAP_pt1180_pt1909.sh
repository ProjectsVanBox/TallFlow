...
CONFIG=run_NF_IAP_pt1180_pt1909.config
...
/hpc/pmc_vanboxtel/tools/external/nextflow_v20.03.0-edge.5288/nextflow run /hpc/pmc_vanboxtel/tools/ToolsVanBox/NF-IAP_v1.3.0/nf-iap.nf \
 -c ${CONFIG} --out_dir /hpc/pmc_vanboxtel/projects/TallFlow/3_Output/HaplotypeCaller/pt1180_pt1909/ -profile slurm -resume
