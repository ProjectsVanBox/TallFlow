...
#SBATCH -o /hpc/pmc_vanboxtel/projects/TallFlow/3_Output/PTATO/pt2322/PTATO.out
#SBATCH -e /hpc/pmc_vanboxtel/projects/TallFlow/3_Output/PTATO/pt2322/PTATO.error
...
/hpc/pmc_vanboxtel/tools/ToolsVanBox_DEV/PTATO_SMuRF3/ptato.nf \
-c ${run_config_file} \
--out_dir /hpc/pmc_vanboxtel/projects/TallFlow/3_Output/PTATO/pt2322 \
