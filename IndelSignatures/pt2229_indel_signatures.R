...
setwd("~/hpc/pmc_vanboxtel/projects/TallFlow/3_Output/IndelSignatures/pt2229")

vcf_files <- list.files("../../TreeBuilding_indel/pt2229/branches_vcfs/","branch.vcf",full.names = T)
...
pooled_indel_counts <- pool_mut_mat(indel_counts, grouping = c(rep("rest",7),"root"))

pdf("pt2229_signatures_overview.pdf")
...
strict_refit <- fit_to_signatures_strict(pooled_indel_counts, indel_signatures, max_delta = 0.06)
