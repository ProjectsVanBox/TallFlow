...
path_of_the_directory= '/Users/ricohagelaar/Documents/Thymus_Project/FlowCytometry/TallFlow/1_Input/FCS_Thymus_MoreSamples/'
...
for filename in os.listdir(path_of_the_directory):
	...
	if os.path.isfile(FlowFile):
		...
		if (SampleName == ".DS_Store"):
			...
			#print(FlowFile)
			FlowOutfile = "/Users/ricohagelaar/Documents/Thymus_Project/FlowCytometry/TallFlow/3_Output/PythonGating/ThymusMore/"+SampleName+"_keymarkers.csv"
			ScriptFile = "/Users/ricohagelaar/Documents/Thymus_Project/FlowCytometry/TallFlow/2_Code/PythonGating/Thy_more_scripts/"+SampleName+".py"
			#print("")
