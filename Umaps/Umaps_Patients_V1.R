...
### read in data  
file_dir <- "/hpc/pmc_vanboxtel/projects/TallFlow/3_Output/PythonGating/PatientStrict/"
...
all.df <- all.df[all.df$SampleIDshort != "pt5716",]
...
ggsave(filename = "../../../3_Output/Umaps/Patients/CombinedUmap_Celltype.pdf", p1)
ggsave(filename = "../../../3_Output/Umaps/Patients/CombinedUmap_SampleID.pdf", p2)
...
pdf("../../../3_Output/Umaps/Patients/CombinedUmap_louvainclusters.pdf")
...
for (marker in lineage_markers){
  ...
  png(paste0("../../../3_Output/Umaps/Patients/MarkerPlots/Combined_umap_", marker, ".png"))
  print(p)
  dev.off()
}
...
### Save data
saveRDS(all.df, "../../../3_Output/Umaps/Patients/CombinedPatients.rds")
