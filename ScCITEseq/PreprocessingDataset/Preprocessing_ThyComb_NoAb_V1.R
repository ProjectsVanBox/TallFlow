...
inputdir = "../../1_Input/10x/"
outputdir = "../../3_Output/10x_ThyComb_NoAbFilt/Preprocessing/"
plotdir = paste0(outputdir, "Plots/")
project = "Thy_Combined"
# Metadata
...
saveRDS(srat, paste0(outputdir,"srat_10xThyComb_Preprocessing.rds"))
