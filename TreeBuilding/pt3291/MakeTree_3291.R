...
setwd("~/hpc/projects/TallFlow/3_Output/TreeBuilding/pt3291/")
...
co_occur_m <- co_occur_m[,!colnames(co_occur_m) %in% c("pt3291-DX1BM-ALLBULK","pt344-DX1PB-MONOBULK")]
...
tip.color[grep(rooted_tree$tip.label, pattern = "TALL10$")] <- "#E28028"
tip.color[grep(rooted_tree$tip.label, pattern = "TALL11$")] <- "#E28028"
tip.color[grep(rooted_tree$tip.label, pattern = "TALL12$")] <- "#E28028"

pdf("/Users/verapoort/Desktop/pt3291_tree.pdf")
