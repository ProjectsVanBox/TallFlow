...
setwd("~/hpc/projects/TallFlow/3_Output/TreeBuilding/pt344/")
...
co_occur_m <- co_occur_m[,-which(c("pt344-DX1BM-ALLBULK","pt344-DX1PB-MONOBULK") %in% colnames(co_occur_m))]
...
tip.color[grep(rooted_tree$tip.label, pattern = "TALL1$")] <- "#385725"
tip.color[grep(rooted_tree$tip.label, pattern = "TALL2$")] <- "#385725"
tip.color[grep(rooted_tree$tip.label, pattern = "TALL3$")] <- "#385725"
tip.color[grep(rooted_tree$tip.label, pattern = "TALL4$")] <- "#B17BA6"
tip.color[grep(rooted_tree$tip.label, pattern = "TALL5$")] <- "#B17BA6"
tip.color[grep(rooted_tree$tip.label, pattern = "TALL6$")] <- "#B17BA6"
tip.color[grep(rooted_tree$tip.label, pattern = "TALL7$")] <- "#E28028"
tip.color[grep(rooted_tree$tip.label, pattern = "TALL8$")] <- "#E28028"
tip.color[grep(rooted_tree$tip.label, pattern = "TALL9$")] <- "#E28028"


pdf("/Users/verapoort/Desktop/pt344_tree.pdf")
