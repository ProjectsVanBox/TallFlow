...
setwd("/Users/v.m.poort/hpc/pmc_vanboxtel/projects/TallFlow/3_Output/TreeBuilding/CellPhyWrapper/DxRelsamples/pt1180_pt1909/")

tree = readRDS("TreeObject0.3.RDS")
vcf = VariantAnnotation::readVcf("../../../../../1_Input/TreeBuilding/pt1180_pt1909/pt1180_pt1909_filtered_snv_NoBulk.vcf")
...
new = c("pt1180-TALL12", "pt1180-TALL10", "pt1180-TALL1", "pt1180-TALL2", "pt1180-MSCBULK", "pt1180-TALL8", "pt1180-TALL20", 
        "pt1180-TALL15", "pt1180-TALL14", "pt1180-TALL18", "pt1180-TALL21", "pt1180-TALL19", "pt1180-TALL13", "pt1180-TALL17", 
        "pt1180-TALL16", "pt1180-TALL7", "pt1180-TALL9", "pt1180-TALL4", "pt1180-TALL5", "pt1180-TALL11", "pt1180-TALL6", 
        "pt1180-TALL3")
tip_names_replace = data.frame(old, new)
tree_rename = change_tip_labels(tree = tree, id_change_tb = tip_names_replace)
plot_gg_tree_base(tree_rename)
ggsave("../../pt1180_CellphyPloting_branchNames.pdf")
plot_gg_tree(tree_rename, add_branch_length = F, add_bootstrap = F, branch_text_size = 7)
ggsave("../../pt1180_CellphyPloting.pdf")
...
## save branches VCFs
dir.create("../../pt1180_branches_vcf")
for ( i in names(branch_vcf)){
  print(i)
  writeVcf(branch_vcf[[i]], filename = paste0("../../pt1180_branches_vcf/", i, "_branch.vcf"))
}
