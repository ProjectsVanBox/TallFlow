...
cd /hpc/pmc_vanboxtel/projects/TallFlow/3_Output/TreeBuilding/pt2229_new/withoutBulk/branches_vcfs

VCF=/hpc/pmc_vanboxtel/projects/TallFlow/3_Output/TreeBuilding/pt2229_new/SMuRF.filtered.coords.vcf
