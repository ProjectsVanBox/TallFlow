...
indel_vcf_files <- list.files("~/hpc/pmc_vanboxtel/projects/TallFlow/3_Output/TreeBuilding_indel/pt2229/branches_vcfs/","branch.vcf",full.names = T)
...
pdf("pt2229_tree_incl_INDEL.pdf")
