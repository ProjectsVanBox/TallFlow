...
setwd("~/hpc/pmc_vanboxtel/projects/TallFlow/3_Output/TreeBuilding/pt1909/")
...
upset_matrix <- upset_matrix[which(rowSums(upset_matrix) < 8),]
pdf("pt1909_Upsetplot.pdf")
