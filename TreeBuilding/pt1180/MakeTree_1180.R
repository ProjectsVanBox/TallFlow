...
setwd("~/hpc/projects/TallFlow/3_Output/TreeBuilding/pt1180/")
...
co_occur_m <- co_occur_m[,!colnames(co_occur_m) %in% c("pt1180-DX1BM-ALLBULK","pt1180-DX1BM-MSCBULK")]
...
tip.color[grep(rooted_tree$tip.label, pattern = "TALL8$")] <- "#E7298A"
tip.color[grep(rooted_tree$tip.label, pattern = "TALL9$")] <- "#E7298A"
...
pdf("/Users/verapoort/Desktop/pt1180_tree.pdf")
