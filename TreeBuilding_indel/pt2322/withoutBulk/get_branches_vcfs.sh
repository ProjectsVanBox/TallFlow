...
cd /hpc/pmc_vanboxtel/projects/TallFlow/3_Output/TreeBuilding_indel/pt2322/withoutBulk/branches_vcfs

VCF=/hpc/pmc_vanboxtel/projects/TallFlow/3_Output/TreeBuilding_indel/pt2322/SMuRF.filtered.coords.vcf
...
>> TALL10_TALL9_TALL11_branch.vcf
