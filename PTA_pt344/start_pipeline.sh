...
#SBATCH -o /hpc/pmc_vanboxtel/projects/TallFlow/3_Output/PTATO_Dev/pt344/PTATO.out
#SBATCH -e /hpc/pmc_vanboxtel/projects/TallFlow/3_Output/PTATO_Dev/pt344/PTATO.error
