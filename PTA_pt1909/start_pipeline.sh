...
#SBATCH -o /hpc/pmc_vanboxtel/projects/TallFlow/3_Output/PTATO_Dev/pt1909/PTATO.out
#SBATCH -e /hpc/pmc_vanboxtel/projects/TallFlow/3_Output/PTATO_Dev/pt1909/PTATO.error
...
-c ${run_config_file} \
--out_dir /hpc/pmc_vanboxtel/projects/TallFlow/3_Output/PTATO_Dev/pt1909 \
