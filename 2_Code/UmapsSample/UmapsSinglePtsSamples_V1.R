...
### Load data  
setwd("/Users/ricohagelaar/Documents/Thymus_Project/FlowCytometry/TallFlow/3_Output/Umaps/Patients/")
all.df <- readRDS("./CombinedPatients.rds")
...
for (s in sampleNames){
  ...
  ### Create directories
  dir.create(paste0("./SinglePatientUmap/", s))
  dir.create(paste0("./SinglePatientUmap/", s, "/MarkerPlots"))
  ...
  ggsave(filename = paste0("./SinglePatientUmap/", s, "/", s, "_Umap_Celltype.pdf"), p1)
  ggsave(filename = paste0("./SinglePatientUmap/", s, "/", s, "_Umap_SampleID.pdf"), p2)
  ...
  ggsave(filename = paste0("./SinglePatientUmap/", s, "/", s, "_Umap_louvainclusters.pdf"), p3)
  ...
  for (marker in lineage_markers){
    ...
    png(paste0("./SinglePatientUmap/", s, "/MarkerPlots/", s, "_umap_", marker, ".png"))
    print(p)
    dev.off()
  }
  
  ### Save data
  saveRDS(single.df, paste0("./SinglePatientUmap/", s, "/", s, "_data.rds"))
}
