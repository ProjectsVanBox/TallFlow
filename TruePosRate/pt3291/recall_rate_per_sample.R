...
setwd("~/hpc/pmc_vanboxtel/projects/TallFlow/3_Output/TruePosRate/pt3291/")

myBulkVcf_fname <- "~/hpc/pmc_vanboxtel/projects/TallFlow/3_Output/BulkSeq_SMuRF/pt3291/230918_HMFreg2063_pt3291_Bulk.vcf.filtered_variants_dbnsfp_CosmicCodingMuts_gonl.snps_indels.r5.liftover.hg38.sorted_pt3291-DX1PB-ALLBULK.SMuRF.filtered.vcf"

myBulkVcf <- readVcf(myBulkVcf_fname)
myBulkVcfgr <- granges(myBulkVcf)

mySingleSampleSMuRF_fname <- "~/hpc/pmc_vanboxtel/projects/TallFlow/3_Output/PTATO_Dev/pt3291/intermediate/short_variants/SMuRF/pt3291/231016_HMFreg2090_pt3291.vcf.filtered_variants_dbnsfp_CosmicCodingMuts_gonl.snps_indels.r5.liftover.hg38.sorted.SMuRF.filtered.vcf"
...
colnames(clonal_table) <- gsub(".+(BM|PB)-(.+)","\\2",colnames(clonal_table))
