...
setwd("~/hpc/pmc_vanboxtel/projects/TallFlow/3_Output/TruePosRate/pt2283D//")

myBulkVcf_fname <- "~/hpc/pmc_vanboxtel/projects/TallFlow/3_Output/PTATO_Dev/pt2283D/intermediate/short_variants/somatic_vcfs/pt2283D/230307_HMF1931_pt2283D.vcf.filtered_variants_dbnsfp_CosmicCodingMuts_gonl.snps_indels.r5.liftover.hg38.sorted_pt2283D-DX1BM-ALLBULK.SMuRF.filtered.vcf.gz"
...
TALL3_missed <- clonal_table[clonal_table[,"TALL3"] == 0 & clonal_table[,"TALL12"] == 1 & rowSums(clonal_table) >= 11,]
TALL12_missed <- clonal_table[clonal_table[,"TALL12"] == 0 & clonal_table[,"TALL3"] == 1 & rowSums(clonal_table) >= 11,]
