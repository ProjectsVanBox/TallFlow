...
DONOR="pt2322"
CONTROL_CL="/hpc/pmc_vanboxtel/projects/TallFlow/3_Output/CallableLociBulk/pt2322/pt2322-DX1BM-MONOBULK_dedup_CallableLoci.bed"
CONTROL=$( echo ${CONTROL_CL} | grep -oP "[\w,-]+.CallableLoci.bed" | cut -f1 -d'_')
for SAMPLE_CL in /hpc/pmc_vanboxtel/projects/TallFlow/3_Output/CallableLociBulk/pt2322/*CallableLoci.bed; do
    ...
    for SAMPLE_VCF in /hpc/pmc_vanboxtel/projects/TallFlow/3_Output/BulkSeq_SMuRF/pt2322/221026_HMFreg1816_pt2322.vcf.filtered_variants_dbnsfp_CosmicCodingMuts_gonl.snps_indels.r5.liftover.hg38.sorted_*${SAMPLE}.SMuRF.filtered.vcf; do
    	#echo $SAMPLE_VCF
