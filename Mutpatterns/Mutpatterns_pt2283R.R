...
### Read in data 
vcf_files <- list.files(path = "/Users/ricohagelaar/hpc/pmc_vanboxtel/projects/TallFlow/3_Output/BulkSeq_SMuRF/pt2283R/SingleVCFs/",
                        pattern = "*filtered.vcf$", full.names = TRUE, recursive = TRUE )
sample_names <- c("pt2283R-DX1BM-ALLBULK-DN", "pt2283R-DX1BM-ALLBULK-DP", "pt2283R-DX1BM-ALLBULK-iSPCD4", "pt2283R-DX1BM-ALLBULK-SPCD4", "pt2283R-DX1BM-ALLBULK")
mut_grl <- read_vcfs_as_granges(vcf_files, sample_names, genome = ref_genome)


#mut_grl2 <- read_vcfs_as_granges(vcf_files, c("pt2283R-DX1BM-ALLBULK", "pt2283R-DX1BM-ALLBULK-DN", "pt2283R-DX1BM-ALLBULK-DP", "pt2283R-DX1BM-ALLBULK-iSPCD4", "pt2283R-DX1BM-ALLBULK-SPCD4"), genome = ref_genome)
...
pdf("/Users/ricohagelaar/Documents/Thymus_Project/FlowCytometry/TallFlow/3_Output/Mutpatterns/pt2283R/DeNovo/pt2283R_estimates.pdf")
plot(estimate)
dev.off()
...
pdf("/Users/ricohagelaar/Documents/Thymus_Project/FlowCytometry/TallFlow/3_Output/Mutpatterns/pt2283R/DeNovo/pt2283R_96profile.pdf")
plot_96_profile(nmf_res$signatures, condensed = TRUE)
dev.off()

pdf("/Users/ricohagelaar/Documents/Thymus_Project/FlowCytometry/TallFlow/3_Output/Mutpatterns/pt2283R/DeNovo/pt2283R_rel_contribution.pdf")
plot_contribution(nmf_res$contribution[,1:5], nmf_res$signature,
                  mode = "relative"
) + 
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
dev.off()

pdf("/Users/ricohagelaar/Documents/Thymus_Project/FlowCytometry/TallFlow/3_Output/Mutpatterns/pt2283R/DeNovo/pt2283R_abs_contribution.pdf")
plot_contribution(nmf_res$contribution[,1:5], nmf_res$signature,
                  mode = "absolute"
) + 
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
dev.off()
pdf("/Users/ricohagelaar/Documents/Thymus_Project/FlowCytometry/TallFlow/3_Output/Mutpatterns/pt2283R/DeNovo/pt2283R_orig_vs_recon.pdf")
...
pdf("/Users/ricohagelaar/Documents/Thymus_Project/FlowCytometry/TallFlow/3_Output/Mutpatterns/pt2283R/MutSpectrumStacked.pdf")
plot_spectrum_stacked(type_occurrences)
dev.off()
write.table(type_occurrences, "/Users/ricohagelaar/Documents/Thymus_Project/FlowCytometry/TallFlow/3_Output/Mutpatterns/pt2283R/MutSpectrum.txt", sep = "\t", col.names = NA)
