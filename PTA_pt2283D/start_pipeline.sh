...
#SBATCH -o /hpc/pmc_vanboxtel/projects/TallFlow/3_Output/PTATO_Dev/pt2283D/PTATO.out
#SBATCH -e /hpc/pmc_vanboxtel/projects/TallFlow/3_Output/PTATO_Dev/pt2283D/PTATO.error
...
/hpc/pmc_vanboxtel/tools/ToolsVanBox/PTATO-1.0.0/ptato.nf \
-c ${run_config_file} \
--out_dir /hpc/pmc_vanboxtel/projects/TallFlow/3_Output/PTATO_Dev/pt2283D \
